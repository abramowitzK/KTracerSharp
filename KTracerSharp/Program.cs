...
namespace KTracerSharp {
	public class Program {
		public static void Main(string[] args) {
			...
			mesh.Mat = new Material(150f, new Vector4(0.7f, 0.0f, 0.7f, 1.0f), new Vector4(1.0f, 1.0f, 1.0f, 1.0f),
				new Vector4(0.7f, 0f, 0.7f, 1f), 0.15f, 0.3f, 0.5f);
			mesh.UniformScale(2);
			...
			var s3 = new Sphere(new Vector3(3.0f, 0.0f, 3.0f), Quaternion.Identity, 1f, new Vector4(0.1f, 0.4f, 0.1f, 1.0f), 1.4f) {
				Mat = new Material(5f, new Vector4(0.2f, 0.3f, 0.7f, 1.0f), new Vector4(1.0f, 1.0f, 1.0f, 1.0f),
				new Vector4(0.2f, 0.3f, 0.7f, 1f), 0.3f, 0.6f, 0.4f)
			};
			...
			scene.AddLight(new Light(new Vector3(3f, 0f, 3f), new Vector4(1.0f,1.0f,1.0f,1.0f), 3.0f));
			//scene.AddLight(new Light(new Vector3(5, 1f, 4f), new Vector4(1.0f, 1.0f, 1.0f, 1.0f), 3.0f));
			scene.AddLight(new Light(new Vector3(0, 0f, 3f), new Vector4(1.0f, 1.0f, 1.0f, 1.0f), 3.0f));
